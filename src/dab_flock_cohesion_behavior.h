/** \file dab_flock_cohesion_behavior.h
 *  \class dab::flock::CohesionBehavior cause Agent to move towards center position of their neigbhors
 *	\brief cause Agent to move towards center position of their neigbhors
 *
...
#ifndef _dab_flock_cohesion_behavior_h_
#define _dab_flock_cohesion_behavior_h_
...
public:
     ...
     */
    CohesionBehavior(const std::string& pInputParameterString, const std::string& pOutputParameterString);
     ...
     */
    CohesionBehavior(Agent* pAgent, const std::string& pBehaviorName, const std::string& pInputParameterString, const std::string& pOutputParameterString) throw (Exception);
