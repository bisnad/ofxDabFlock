/** \file dab_flock_env_clamp_behavior.h
 */

#ifndef _dab_flock_env_clamp_behavior_h_
#define _dab_flock_env_clamp_behavior_h_
...
class EnvClampBehavior : public EnvBehavior
{
public:
    EnvClampBehavior(const std::string& pInputParameterString, const std::string& pOutputParameterString);
    EnvClampBehavior(Env* pEnv, const std::string& pBehaviorName, const std::string& pInputParameterString, const std::string& pOutputParameterString);
    ~EnvClampBehavior();
...
protected:
    ...
    Parameter* mClampMinPar; // internal parameter
    Parameter* mClampMaxPar; // internal parameter
