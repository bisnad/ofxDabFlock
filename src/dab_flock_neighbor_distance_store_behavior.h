/** \file dab_flock_neighbor_distance_store_behavior.h
 ...
 *
 *  The Behavior stores the distance of neighbors in an output parameter\n
...
#ifndef _dab_flock_neighbor_distance_store_behavior_h_
#define _dab_flock_neighbor_distance_store_behavior_h_
...
class NeighborDistanceStoreBehavior : public Behavior
{
public:
    /**
     ...
     */
    NeighborDistanceStoreBehavior(const std::string& pInputParameterString, const std::string& pOutputParameterString);
     ...
     */
    NeighborDistanceStoreBehavior(Agent* pAgent, const std::string& pBehaviorName, const std::string& pInputParameterString, const std::string& pOutputParameterString) throw (Exception);
